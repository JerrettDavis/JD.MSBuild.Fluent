...
public class XmlToFluentScaffolder
{
    ...
    private void GenerateFactoryClass(XElement root, string packageId, string className, string fileName, bool returnMsBuildProject)
    {
        ...
        AppendLine("using JD.MSBuild.Fluent.IR;");
        AppendLine();
        ...
        if (returnMsBuildProject)
        {
            ...
            if (hasProps)
            {
                ...
                AppendLine("{");
                _indent++;
                AppendLine("var project = new MsBuildProject { Label = \"Generated by JD.MSBuild.Fluent\" };");
                AppendLine("var p = PropsBuilder.For(project);");
                AppendLine();
                GeneratePropsContent(root);
                AppendLine();
                AppendLine("return project;");
                _indent--;
                AppendLine("}");
            }
            else if (hasTargets)
            {
                ...
                _indent++;
                AppendLine("var project = new MsBuildProject { Label = \"Generated by JD.MSBuild.Fluent\" };");
                AppendLine("var t = TargetsBuilder.For(project);");
                AppendLine();
